  ...
  return (
    <div className={clsx('pbc pbc:relative pbc:w-full pbc:p-0 pbc:m-0', wrapperClassName)}>
      <textarea
        ...
        disabled={disabled}
        className={clsx(
          'pbc pbc:border-solid pbc:block pbc:border pbc:bg-transparent pbc:w-full pbc-scrollbar-hidden pbc:appearance-none pbc:transition-colors pbc:duration-150 pbc:placeholder:text-basic-light pbc:text-basic-main pbc:focus:ring-0 pbc:focus:ring-offset-0',
          !error &&
